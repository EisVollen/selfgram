...
{
    public partial class CreateSelfgramTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    header = table.Column<string>(maxLength: 40, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Publications_AspNetUsers_author_id",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(nullable: false),
                    publication_id = table.Column<Guid>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Likes_Publications_publication_id",
