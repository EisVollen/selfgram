...
namespace Selfgram.Application.Controllers
{
    public class PublicationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Header,ImagePath,Tags,PublicDate")] Publication publication)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Header,ImagePath,Tags,PublicDate")] Publication publication)
        {
